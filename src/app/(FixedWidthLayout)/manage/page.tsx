...
const ProfileCard = ({ profile }: { profile: DinnerProfileRecord }) => (
    <div className="bg-gradient-to-br from-white/95 to-rose-50/30 dark:from-luxury-900/95 dark:to-luxury-800/80 rounded-2xl shadow-glass overflow-hidden backdrop-blur-sm border border-white/20 p-6 transition-all duration-300 hover:shadow-elevated hover-lift">
        <div className="flex items-start space-x-4">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="space-y-2 text-sm text-pearl-600 dark:text-pearl-300">
                    ...
                    <div className="flex items-center">
                        ...
                        <span>{profile.unit || "No unit specified"}</span>
                    </div>

                    {profile.isWorker && (
                        <div className="flex items-center">
                            <GraduationCap className="w-4 h-4 mr-2" />
                            <span className="text-champagne-gold-600 dark:text-champagne-gold-400">
                                Worker
                            </span>
                        </div>
                    )}
...
const SearchState = ({ count }: { count: number }) => (
...
export default observer(DinnerProfilesManager);
