...
function VoteStatCard(props: VoteCardProps) {

    const {obtainGuestRecord, handleSelection} = useVote();
    ...
    return (
        ...
        >
            <div
                className="avatar-wrapper-container"
            ...
            <div className="voter-card-name">
                ...
                {props.contestant.alias && (
                    <p className="fs-16">({props.contestant.alias})</p>
                )}
            </div>
            <div className="voter-card-info">
                {/* <div className="shimmer"></div> */}
                <p className="ff-poppins fs-18 text-capitalize">
            ...
            <div className="voter-card-button">
                ...
                <input
                    ...
                    id="vote-check"
                    disabled
                    data-filled={isWinner}
                />

                <button
                    disabled
                    onClick={handleSelect}
                    className="clr-primary ff-riffic"
                >
                    {votes} / {totalVotes}
                </button>
            </div>
